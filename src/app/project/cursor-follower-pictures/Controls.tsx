...
export default function Controls({ opacity, lifespan, pictureSize, trailLength, spawnDistance, onUpdate }: ControlsProps) {
  return (
    <>
      ...
      <Slider label="Trail Length" value={trailLength} min={1} max={20} step={1} onChange={(v) => onUpdate({ trailLength: v })} />
